    ...
    return reports
        .map(report => {
            return {
                ...
                totalEquity: report.equityTotal,
                ...
                netDebt: threeVariableOperation(report.assetCurrentCashEquivalents, report.liabilityCurrentDebt, report.liabilityNonCurrentDebt, (a, b, c) => (b + c) - a),
                link: null,
                finalLink: null
            }
        })
